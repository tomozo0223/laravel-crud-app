    ...
    <div class="w-3xl m-auto">
        ...
        <form wire:submit="update">
            <div class="w-3xl mt-4">
                <input type="text" wire:model="title" placeholder="タイトルを入力してください"
                    class="w-full border-1 rounded-md p-2" value="{{ $post->title }}">
                @error('title')
            ...
            <div class="flex justify-end mt-4 gap-2">
                <flux:button href="{{ route('posts.show', $post->id) }}" variant="primary" color="blue">詳細に戻る
                </flux:button>
                <div>
